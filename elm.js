...
{
	if (region.dv.a5 === region.dZ.a5)
	{
		return 'on line ' + region.dv.a5;
	}
	return 'on lines ' + region.dv.a5 + ' through ' + region.dZ.a5;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { d3: 'hidden', e9: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { d3: 'mozHidden', e9: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { d3: 'msHidden', e9: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { d3: 'webkitHidden', e9: 'webkitvisibilitychange' }
		: { d3: 'hidden', e9: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.aA, request.X, true);
		} catch (e) {
...
function _Http_track(router, xhr, tracker)
{
	...
	xhr.addEventListener('progress', function(event) {
		...
		_Scheduler_rawSpawn(A2($elm$core$Platform$sendToSelf, router, _Utils_Tuple2(tracker, $elm$http$Http$Receiving({
			fy: event.loaded,
			eL: event.lengthComputable ? $elm$core$Maybe$Just(event.total) : $elm$core$Maybe$Nothing
		}))));
	});
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {d1: fragment, d4: host, ep: path, er: port_, ew: protocol, cD: query};
	});
...
var $author$project$Problems$addProblem = F2(
	function (model, problem) {
		return _Utils_update(
			model,
			{
				bw: $rundis$elm_bootstrap$Bootstrap$Alert$shown,
				bf: A2($elm$core$List$cons, problem, model.bf)
			});
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $author$project$Main$Flags = F4(
	function (weave, research, buildTarget, version) {
		return {p: buildTarget, t: research, e1: version, aN: weave};
	});
...
var $author$project$Main$decodeFlags = A5(
...
var $author$project$Settings$editorVersion = '2.1.5';
...
var $author$project$RCMediaEdit$empty = {bC: false, ek: $elm$core$Maybe$Nothing, el: $elm$core$Maybe$Nothing, c_: $rundis$elm_bootstrap$Bootstrap$Modal$hidden};
...
var $author$project$RCMediaList$empty = {
	...
	cD: '',
	cN: $billstclair$elm_sortable_table$Table$initialSort('ID')
};
...
var $rundis$elm_bootstrap$Bootstrap$Dropdown$initialState = {
	...
	eO: 2,
	cQ: A4($rundis$elm_bootstrap$Bootstrap$Utilities$DomHelper$Area, 0, 0, 0, 0)
};
...
var $author$project$RCAPI$APIAdditionalMediaMetadata = F3(
	function (id, name, userClass) {
		return {j: id, l: name, Y: userClass};
	});
...
var $author$project$RCAPI$APIExpositionMetadata = F2(
	function (editorVersion, contentVersion) {
		return {bQ: contentVersion, dX: editorVersion};
	});
...
var $author$project$RCAPI$APIExposition = F6(
	function (html, markdown, media, metadata, style, title) {
		return {db: html, fp: markdown, n: media, cb: metadata, eP: style, dD: title};
	});
	...
	function (toResult, response) {
		switch (response.$) {
			...
			case 3:
				...
				return $elm$core$Result$Err(
					$elm$http$Http$BadStatus(metadata.fB));
			default:
				var body = response.b;
				return A2(
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{e6: false, K: r.K, N: r.N, at: r.at, aA: r.aA, aJ: r.aJ, aK: r.aK, X: r.X}));
};
		...
		return $elm$http$Http$request(
			{
				...
				X: 'text-editor/load?research=' + ($elm$core$String$fromInt(researchId) + ('&weave=' + $elm$core$String$fromInt(weave)))
			});
	});
					...
					A2(
						...
						function (s) {
							return _Utils_update(
								s,
								{
									bs: $elm$core$Maybe$Just(vp.e2.e3)
								});
						},
						state));
			},
...
var $author$project$Main$init = function (flags) {
	...
	if (!_v1.$) {
		var fl = _v1.a;
		return _Utils_Tuple2(
			A5($author$project$Main$emptyModel, fl.e1, navbarState, fl.p, fl.t, fl.aN),
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						navCmd,
						A3($author$project$RCAPI$getExposition, fl.t, fl.aN, $author$project$Main$GotExposition)
					])));
	} else {
		var e = _v1.a;
		return _Utils_Tuple2(
...
var $elm$time$Time$State = F2(
	function (taggers, processes) {
		return {ev: processes, eS: taggers};
	});
...
var $elm$time$Time$onSelfMsg = F3(
	function (router, interval, state) {
		var _v0 = A2($elm$core$Dict$get, interval, state.eS);
		if (_v0.$ === 1) {
			return $elm$core$Task$succeed(state);
		} else {
			var taggers = _v0.a;
...
var $elm$browser$Browser$AnimationManager$State = F3(
	function (subs, request, oldTime) {
		return {dj: oldTime, eC: request, eQ: subs};
	});
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A2($rundis$elm_bootstrap$Bootstrap$Dropdown$subscriptions, model.aY, $author$project$Main$ExportDropMsg),
				A2(
				$elm$time$Time$every,
				10000,
				function (_v0) {
				...
				A2($rundis$elm_bootstrap$Bootstrap$Navbar$subscriptions, model.ba, $author$project$Main$NavbarMsg)
			]));
};
...
var $author$project$Problems$addProblems = F2(
	function (model, problems) {
		return _Utils_update(
			...
			{
				bw: $rundis$elm_bootstrap$Bootstrap$Alert$shown,
				bf: _Utils_ap(problems, model.bf)
			});
	});
var $author$project$RCAPI$APIMedia = F4(
	function (mediaType, status, width, height) {
		return {d2: height, b9: mediaType, eO: status, e3: width};
	});
...
var $author$project$RCAPI$APIMediaEntry = F6(
	function (id, media, description, copyright, name, license) {
		return {aT: copyright, aV: description, j: id, b6: license, n: media, l: name};
	});
...
var $author$project$UserConfirm$Model = F3(
	function (visibility, content, actions) {
		return {e5: actions, c3: content, c_: visibility};
	});
...
var $author$project$Main$confirmObjectDelete = function (object) {
	var messages = $elm$core$Maybe$Just(
		{
			dR: $author$project$Main$MediaDelete(object),
			ey: $author$project$Main$CloseConfirmDialog
		});
	var content = $elm$core$Maybe$Just(
		{dR: 'Delete', fx: object.l + ' is about to be deleted. Are you sure?', ey: 'Keep'});
...
var $author$project$Settings$BuildSetting = F3(
	function (release, dev, local) {
		return {dV: dev, eh: local, ez: release};
	});
...
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{K: r.K, N: r.N, at: _List_Nil, aA: 'POST', aJ: $elm$core$Maybe$Nothing, aK: $elm$core$Maybe$Nothing, X: r.X});
};
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {fk: index, fq: match, fs: number, cO: submatches};
	});
...
var $author$project$Exposition$mediaUrl = function (data) {
	return '/text-editor/simple-media-resource?research=' + ($elm$core$String$fromInt(data.bV) + ('&simple-media=' + $elm$core$String$fromInt(data.j)));
};
		...
		return $elm$http$Http$post(
			{
				...
				X: 'text-editor/export' + ('?type=' + $author$project$RCAPI$typeEnding(ctype))
			});
	});
		...
		return $elm$http$Http$post(
			{
				...
				X: 'text-editor/simple-media-remove?research=' + ($elm$core$String$fromInt(mediaObject.bV) + ('&simple-media=' + $elm$core$String$fromInt(mediaObject.j)))
			});
	});
				...
				[
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2(obj.Y, obj.Y !== ''),
							_Utils_Tuple2(
							$author$project$Exposition$rcClass(obj.b9),
							true),
							_Utils_Tuple2(
...
var $author$project$Exposition$asHtml = F2(
	function (media, mediaId) {
		...
		if (_v0.$ === 1) {
			...
			var _v1 = _Utils_Tuple2(media.b9, media);
			switch (_v1.a.$) {
				case 4:
					var _v2 = _v1.a;
					var data = _v1.b;
						...
						A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$zwilias$elm_html_string$Html$String$text(data.Z)
										]))
								])));
				case 3:
					var _v3 = _v1.a;
...
var $zwilias$elm_html_string$Html$Types$toString = F2(
	function (depth, html) {
		...
		var initialAcc = {v: 0, z: _List_Nil, U: _List_Nil};
								...
								function (o) {
									return A2(
										...
										A2(
											...
											o,
											'media-' + $elm$core$String$fromInt(m.fs)));
								},
								A2($author$project$Exposition$objectByNameOrId, sub, exp)));
					} else {
						return '';
...
var $author$project$Exposition$withHtml = F2(
	function (exp, content) {
		return _Utils_update(
			exp,
			{cG: '<div class=\"exposition\">' + (content + '</div>')});
	});
...
var $author$project$Main$forceRerender = function (model) {
	var newHtml = A2($author$project$Exposition$insertToolHtml, model.b.a6, model.b);
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{
				b: A2(
					...
					A2(
						...
						A2($author$project$Exposition$withMd, model.b, model.b.a6),
						newHtml),
					model.b.c5)
			}),
...
var $elm$http$Http$fractionSent = function (p) {
	return (!p.eL) ? 1 : A3($elm$core$Basics$clamp, 0, 1, p.fA / p.eL);
};
		...
		return $elm$http$Http$request(
			{
				...
				aJ: $elm$core$Maybe$Nothing,
				aK: $elm$core$Maybe$Nothing,
				X: '/text-editor/simple-media-list?research=' + $elm$core$String$fromInt(id)
			});
	});
...
var $author$project$Exposition$isValid = function (st) {
	var _v0 = _Utils_Tuple2(
		_Utils_Tuple2(st.l, st.aV),
		_Utils_Tuple2(st.aT, st.Y));
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					_Utils_cmp(s0.en, offset) < 0,
					0,
					{dO: col, e: s0.e, g: s0.g, en: offset, eF: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.en, s.eF, s.dO, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {dO: col, fc: contextStack, eu: problem, eF: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.eF, s.dO, x, s.e));
	});
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.en, s.a);
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{dO: 1, e: s.e, g: s.g, en: s.en + 1, eF: s.eF + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{dO: s.dO + 1, e: s.e, g: s.g, en: newOffset, eF: s.eF, a: s.a}));
		};
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.en, s.eF, s.dO, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{dO: newCol, e: s.e, g: s.g, en: newOffset, eF: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$end = function (x) {
	return function (s) {
		return _Utils_eq(
			...
			s.en) ? A3($elm$parser$Parser$Advanced$Good, false, 0, s) : A2(
			$elm$parser$Parser$Advanced$Bad,
			false,
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.en, s1.en, s0.a),
						a),
					s1);
			}
		};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {dO: col, eu: problem, eF: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.eF, p.dO, p.eu);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{dO: 1, e: _List_Nil, g: 1, en: 0, eF: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {dO: s.dO + (newOffset - s.en), e: s.e, g: s.g, en: newOffset, eF: s.eF, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.eF, s.dO - (floatOffset + s.en), invalid, s.e));
		} else {
			if (_Utils_eq(s.en, floatOffset)) {
				return A2(
					$elm$parser$Parser$Advanced$Bad,
					false,
				...
				if (_Utils_eq(intOffset, floatOffset)) {
					return A5($elm$parser$Parser$Advanced$finalizeInt, invalid, intSettings, s.en, intPair, s);
				} else {
					if (floatSettings.$ === 1) {
						...
						var _v1 = $elm$core$String$toFloat(
							A3($elm$core$String$slice, s.en, floatOffset, s.a));
						if (_v1.$ === 1) {
							return A2(
								$elm$parser$Parser$Advanced$Bad,
								true,
...
var $elm$parser$Parser$Advanced$number = function (c) {
	return function (s) {
		if (A3($elm$parser$Parser$Advanced$isAsciiCode, 48, s.en, s.a)) {
			var zeroOffset = s.en + 1;
			...
			return A6(
				...
				c.eb,
				c.d0,
				A3($elm$parser$Parser$Advanced$consumeBase, 10, s.en, s.a),
				s);
		}
	};
};
					...
					return $elm$json$Json$Encode$object(
						_List_fromArray(
							[
								_Utils_Tuple2(
								'level',
								$elm$json$Json$Encode$int(te.fo)),
								_Utils_Tuple2(
								'title',
								$elm$json$Json$Encode$string(te.dD)),
								_Utils_Tuple2(
								'id',
		...
		return $elm$http$Http$request(
			{
				K: $elm$http$Http$multipartBody(
					_List_fromArray(
						[
							A2($elm$http$Http$stringPart, 'html', exposition.cG),
							A2($elm$http$Http$stringPart, 'markdown', exposition.a6),
							A2($elm$http$Http$stringPart, 'style', exposition.c5),
							A2($elm$http$Http$stringPart, 'title', exposition.dD),
							A2(
										...
										return $elm$json$Json$Encode$object(
											_List_fromArray(
												[
													...
													_Utils_Tuple2(
													'userClass',
													$elm$json$Json$Encode$string(m.Y))
												]));
									},
									exposition.n))),
							A2(
								...
								$elm$json$Json$Encode$object(
									_List_fromArray(
										[
											...
											_Utils_Tuple2(
											'contentVersion',
											$elm$json$Json$Encode$int(exposition.bQ))
										])))),
...
var $author$project$RCAPI$getMetadata = function (exp) {
	...
	if (!_v0.$) {
		var s = _v0.a;
		return {bQ: 0, dX: $author$project$Settings$editorVersion};
	} else {
		var d = _v0.a;
		return d;
	}
...
var $author$project$RCAPI$toRCExposition = F3(
	function (apiExpo, id, weave) {
		var exp = $author$project$RCAPI$decodeMetadata(
			$author$project$RCAPI$decodeMedia(apiExpo));
		var md = ($author$project$RCAPI$getMetadata(exp).dX < '2.0.0') ? _Utils_ap('# ' + (apiExpo.dD + '\n\n'), apiExpo.fp) : apiExpo.fp;
		return {
			dL: _List_Nil,
			bQ: $author$project$RCAPI$getMetadata(exp).bQ,
			c5: apiExpo.eP,
			dS: weave,
			dX: $author$project$Settings$editorVersion,
			j: id,
			a6: md,
			n: _List_Nil,
			cG: apiExpo.db,
...
var $author$project$RCAPI$getDimensions = function (media) {
	var _v0 = _Utils_Tuple2(media.e3, media.d2);
	if ((!_v0.a.$) && (!_v0.b.$)) {
		var w = _v0.a.a;
		var h = _v0.b.a;
		return $elm$core$Maybe$Just(
			...
			return $elm$core$Result$Ok(
				{
					...
					b9: mtype,
					l: mediaEntry.l,
					eO: stringToTranscoding(mediaEntry.n.eO),
					Y: '',
					e1: 0
				});
		} else {
...
var $author$project$RCMediaEdit$showWithObject = F3(
	function (obj, state, allowInsert) {
		return {
			bC: allowInsert,
			ek: $elm$core$Maybe$Just(obj),
			el: $elm$core$Maybe$Just(state),
			c_: $rundis$elm_bootstrap$Bootstrap$Modal$shown
		};
	});
...
var $author$project$Exposition$thumbUrl = function (data) {
	return '/text-editor/simple-media-thumb?research=' + ($elm$core$String$fromInt(data.bV) + ('&simple-media=' + ($elm$core$String$fromInt(data.j) + '&width=132&height=132')));
};
...
var $author$project$Exposition$validateMediaObject = F3(
	function (exp, objInModel, objInEdit) {
		var validation = {
			aT: $author$project$Exposition$validateCopyright(objInEdit.aT),
			aV: $elm$core$Result$Ok(objInEdit.aV),
			b6: $elm$core$Result$Ok(
				$author$project$Licenses$asString(objInEdit.b6)),
			l: A3($author$project$Exposition$validateName, exp, objInModel, objInEdit.l),
			Y: $elm$core$Result$Ok(objInEdit.Y)
		};
		return {
			j: objInModel.j,
			eU: $author$project$Exposition$thumbUrl(objInModel),
			e0: validation
		};
	});
var $author$project$RCMediaEdit$update = F2(
	function (model, message) {
		...
		var _v1 = A2($author$project$Exposition$objectByNameOrId, mediaNameOrId, model.b);
		if (!_v1.$) {
			var obj = _v1.a;
			...
			return _Utils_update(
				model,
				{
					Q: A3($author$project$RCMediaEdit$showWithObject, obj, viewObjectState, showInsert)
				});
		} else {
		...
		$elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'md',
					$elm$json$Json$Encode$string(model.b.a6)),
					_Utils_Tuple2(
					'style',
					$elm$json$Json$Encode$string(model.b.c5))
				])));
};
		...
		return $elm$http$Http$request(
			{
				K: $elm$http$Http$multipartBody(
					_List_fromArray(
						[
							...
							$elm$http$Http$stringPart,
							'copyrightholder',
							A2($author$project$RCAPI$withDefault, 'copyright holder', mediaObject.aT)),
							A2($elm$http$Http$stringPart, 'description', mediaObject.aV),
							A2(
							$elm$http$Http$stringPart,
							'license',
							$author$project$Licenses$asString(mediaObject.b6))
						])),
				N: expect,
				at: _List_fromArray(
					[
				...
				aJ: $elm$core$Maybe$Nothing,
				aK: $elm$core$Maybe$Nothing,
				X: 'text-editor/simple-media-edit' + ('?research=' + ($elm$core$String$fromInt(mediaObject.bV) + ('&simple-media=' + $elm$core$String$fromInt(mediaObject.j))))
			});
	});
var $author$project$Exposition$TOCEntry = F3(
	function (level, title, id) {
		return {j: id, fo: level, dD: title};
	});
...
var $author$project$Exposition$updateToc = F2(
	function (expo, tocJs) {
		return _Utils_update(
			expo,
			{
				dE: $author$project$Exposition$makeTocEntries(tocJs)
			});
	});
var $author$project$RCAPI$APIPandocImport = F2(
	function (media, markdown) {
		return {fp: markdown, n: media};
	});
		...
		return $elm$http$Http$request(
			{
				...
				aA: 'POST',
				aJ: $elm$core$Maybe$Nothing,
				aK: $elm$core$Maybe$Just('uploadImport'),
				X: 'text-editor/import' + ('?research=' + $elm$core$String$fromInt(researchId))
			});
	});
			...
			return $elm$http$Http$request(
				{
					...
					aA: 'POST',
					aJ: $elm$core$Maybe$Nothing,
					aK: $elm$core$Maybe$Just('uploadMedia'),
					X: 'text-editor/simple-media-add' + ('?research=' + $elm$core$String$fromInt(researchId))
				});
		}
	});
		...
		while (true) {
			switch (msg.$) {
						...
						_Utils_update(
							model,
							{
								b: A2(
									...
									A2($author$project$Exposition$withHtml, model.b, convObj.db),
									convObj.dE)
							}),
						$author$project$Main$setPreviewContent(convObj.db));
				case 0:
					var val = msg.a;
					var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$Main$decodeGeneration, val);
					if (!_v1.$) {
						var gen = _v1.a;
						return (!_Utils_eq(gen, model.aX)) ? _Utils_Tuple2(
							_Utils_update(
								model,
								{
									aX: gen,
				...
				case 9:
					...
					if (!exp.$) {
						var e = exp.a;
						var newExposition = A3($author$project$RCAPI$toRCExposition, e, model.t, model.aN);
							...
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										...
										A2($author$project$RCAPI$getMediaList, model.t, $author$project$Main$GotMediaList),
										$author$project$Main$setDocumentTitle(newModel.b.dD)
									])));
					} else {
						var err = exp.a;
						return _Utils_Tuple2(
				...
				case 10:
					...
					if (mediaResult.$ === 1) {
						...
						var _v9 = $author$project$Problems$splitResultList(
							A2(
								$elm$core$List$map,
								$author$project$RCAPI$toRCMediaObject(model.t),
								media));
						var problems = _v9.a;
				...
				case 5:
					...
					if (_v12.$ === 1) {
						...
						var dialog = model.Q;
						var _v13 = $author$project$Exposition$isValid(objViewState.e0);
						if (!_v13) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{
										Q: _Utils_update(
											dialog,
											{
												ek: $elm$core$Maybe$Just(objFromDialog),
												el: $elm$core$Maybe$Just(objViewState)
											})
									}),
								$elm$core$Platform$Cmd$none);
						} else {
				...
				case 15:
					var file = msg.a;
					var _v17 = $author$project$Main$importHasCorrectMime(file);
					if (!_v17.$) {
						var okfile = _v17.a;
						return _Utils_Tuple2(
							model,
							A3($author$project$RCAPI$uploadImport, model.t, okfile, $author$project$Main$UploadedImport));
					} else {
						var problem = _v17.a;
						return _Utils_Tuple2(
				...
				case 33:
					...
					return _Utils_Tuple2(
						model,
						A4($author$project$RCAPI$convertExposition, model.p, ctype, model.b, $author$project$Main$DownloadExport));
				case 32:
					var ctype = msg.a;
					var result = msg.b;
					if (result.$ === 1) {
					...
					if (!progress.$) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									a0: $author$project$Main$Uploading(
										$elm$http$Http$fractionSent(p))
								}),
							$elm$core$Platform$Cmd$none);
					} else {
						...
						if (!decoded.$) {
							...
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{az: $author$project$Main$Ready}),
								A2($author$project$RCAPI$getMediaList, model.t, onGotMediaList));
						} else {
							var e = decoded.a;
							return _Utils_Tuple2(
								A2(
							...
							model,
							{
								b: A2(
									...
									A2(
										...
										_Utils_ap(model.b.a6, importResult.fp),
										importResult.n)),
								a0: $author$project$Main$Ready
							});
						return _Utils_Tuple2(
				...
				case 35:
					var nextNumber = $author$project$FootnoteHelper$mdNextFootnoteNum(model.b.a6);
					if (!nextNumber.$) {
					...
					if (!message.$) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									a7: A2($author$project$RCMediaList$update, tableMsg, model.a7)
								}),
							$elm$core$Platform$Cmd$none);
					} else {
				...
				case 40:
					...
					if (!pickerMsg.$) {
						...
						var _v30 = model.r;
						var pickerModel = _v30.a;
						var visibility = _v30.b;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
...
var $author$project$View$defaultButton = function (message) {
	return {d3: false, i: 13, en: false, x: message, dk: _List_Nil, et: false, aH: '', dD: 'button'};
};
				...
				return $author$project$Main$MediaEdit(
					_Utils_Tuple2(
						...
						_Utils_update(
							obj,
							{
								b6: $author$project$Licenses$fromString(input)
							})));
		}
	});
var $author$project$Main$CloseMediaPicker = {$: 39};
var $author$project$Main$makePickerConfig = function (uploadButtonHtml) {
	return {fa: $author$project$Main$CloseMediaPicker, d9: $author$project$Main$InsertMediaAtCursor, ea: $author$project$Main$InsertMediaAsLinkAtCursor, e$: uploadButtonHtml};
};
...
var $author$project$Main$makeTableMessages = function (uploadButtonHtml) {
	return {
		fd: $author$project$Main$ConfirmMediaDelete,
		fe: $author$project$Main$MediaDialog(1),
		d9: $author$project$Main$InsertMediaAtCursor,
		ea: $author$project$Main$InsertMediaAsLinkAtCursor,
		e$: uploadButtonHtml
	};
};
...
var $billstclair$elm_sortable_table$Table$HtmlDetails = F2(
	function (attributes, children) {
		return {aP: attributes, aR: children};
	});
...
var $billstclair$elm_sortable_table$Table$defaultCustomizations = {Z: $elm$core$Maybe$Nothing, eG: $billstclair$elm_sortable_table$Table$simpleRowAttrs, eR: _List_Nil, dA: _List_Nil, dB: $elm$core$Maybe$Nothing, dC: $billstclair$elm_sortable_table$Table$simpleThead};
...
var $rundis$elm_bootstrap$Bootstrap$Internal$Button$defaultOptions = {aP: _List_Nil, bI: false, L: $elm$core$Maybe$Nothing, bU: false, eL: $elm$core$Maybe$Nothing};
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2('disabled', options.bU)
					])),
				$elm$html$Html$Attributes$disabled(options.bU)
			]),
		_Utils_ap(
			function () {
				var _v0 = A2($elm$core$Maybe$andThen, $rundis$elm_bootstrap$Bootstrap$General$Internal$screenSizeOption, options.eL);
				if (!_v0.$) {
					var s = _v0.a;
					return _List_fromArray(
						[
...
var $author$project$RCMediaList$deleteButton = F2(
	function (messages, object) {
		var makeDeleteMessage = A2($elm$core$Basics$composeL, $author$project$RCMediaList$MainMessage, messages.fd);
		return A2(
...
var $author$project$RCMediaList$editButton = F2(
	function (messages, object) {
		var makeEditMessage = A2(
			...
			A2(
				$elm$core$Basics$composeL,
				A2($elm$core$Basics$composeL, $author$project$RCMediaList$MainMessage, messages.fe),
...
var $author$project$RCMediaList$mediaListButtons = function (messages) {
	return $billstclair$elm_sortable_table$Table$veryCustomColumn(
		{
			l: 'Action',
			du: $billstclair$elm_sortable_table$Table$unsortable,
			dF: $author$project$RCMediaList$editObjectButtons(messages)
		});
};
...
var $billstclair$elm_sortable_table$Table$stringColumn = F2(
	function (name, toStr) {
		return {
			l: name,
			du: $billstclair$elm_sortable_table$Table$increasingOrDecreasingBy(toStr),
			dF: A2($elm$core$Basics$composeL, $billstclair$elm_sortable_table$Table$textDetails, toStr)
		};
	});
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							$elm$html$Html$Attributes$loop(settings.b8),
							$elm$html$Html$Attributes$autoplay(settings.bG),
...
var $author$project$RCMediaList$thumbnailColumn = F2(
	function (buildType, previewedMediaId) {
		return $billstclair$elm_sortable_table$Table$veryCustomColumn(
			{
				l: 'Preview',
				du: $billstclair$elm_sortable_table$Table$increasingOrDecreasingBy($author$project$Exposition$getMediaTypeString),
				dF: function (rcObject) {
					var size = function () {
						if (!previewedMediaId.$) {
		...
		return $billstclair$elm_sortable_table$Table$customConfig(
			{
				...
				eW: $author$project$RCMediaList$makeTableMsg
			});
	});
...
var $rundis$elm_bootstrap$Bootstrap$Alert$view = F2(
	function (visibility, _v0) {
		...
		return A2(
			...
			A3($rundis$elm_bootstrap$Bootstrap$Alert$maybeAddDismissButton, visibility, configRec, configRec.aR));
	});
...
var $billstclair$elm_sortable_table$Table$viewCell = F2(
	function (data, _v0) {
		...
		return A2($elm$html$Html$td, details.aP, details.aR);
	});
...
var $billstclair$elm_sortable_table$Table$view = F3(
	function (conf, state, data) {
		...
		var toMsg = conf.eW;
		var columns = conf.dQ;
		var customizations = conf.dT;
		var theadDetails = customizations.dC(
			A2(
				$elm$core$List$map,
		...
		var thead = A2(
			...
			_List_fromArray(
				[
					A2($elm$html$Html$tr, _List_Nil, theadDetails.aR)
				]));
		...
		var tbody = A3(
			...
			A2(
				$elm$core$List$map,
				A3($billstclair$elm_sortable_table$Table$viewRow, toId, columns, customizations.eG),
				sortedData));
		var withFoot = function () {
			var _v1 = customizations.dB;
			if (_v1.$ === 1) {
				return A2($elm$core$List$cons, tbody, _List_Nil);
			} else {
				var attributes = _v1.a.aP;
				var children = _v1.a.aR;
				return A2(
					$elm$core$List$cons,
		...
		return A2(
			...
			customizations.eR,
			function () {
				var _v0 = customizations.Z;
				if (_v0.$ === 1) {
					return A2($elm$core$List$cons, thead, withFoot);
				} else {
					var attributes = _v0.a.aP;
					var children = _v0.a.aR;
					return A2(
						$elm$core$List$cons,
...
var $author$project$RCMediaList$mediaListView = F4(
	function (buildType, model, objects, messages) {
		var uploadBtn = A2($elm$html$Html$map, $author$project$RCMediaList$MainMessage, messages.e$);
		return A5(
			$author$project$RCMediaList$view,
			uploadBtn,
			1,
			model,
			A3($author$project$RCMediaList$configMediaList, buildType, model.aE, messages),
			objects);
	});
...
var $author$project$RCMediaList$insertButton = F2(
	function (messages, object) {
		return A5(
			...
			false,
			'Insert',
			A2($elm$core$Basics$composeL, $author$project$RCMediaList$MainMessage, messages.d9),
			object);
	});
...
var $author$project$RCMediaList$configMediaPicker = F3(
	function (buildType, previewedMediaId, messages) {
		var doubleClickAction = A2($elm$core$Basics$composeL, $author$project$RCMediaList$MainMessage, messages.d9);
			...
			case 2:
				return _List_fromArray(
					[
						...
						$elm$html$Html$Events$on,
						'transitionend',
						$elm$json$Json$Decode$succeed(conf.aS))
					]);
			default:
				return _List_fromArray(
					[
	...
	return _Utils_ap(
		...
		_Utils_ap(
				...
				[
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2('modal-dialog-centered', options.bK),
							_Utils_Tuple2('modal-dialog-scrollable', options.cK)
						])),
			...
			A2(
				$elm$core$Maybe$withDefault,
				_List_Nil,
				A2($elm$core$Maybe$map, $rundis$elm_bootstrap$Bootstrap$Modal$modalClass, options.a9))));
};
						...
						_List_fromArray(
							[
								...
								_Utils_ap(
									...
									_Utils_ap(
										$rundis$elm_bootstrap$Bootstrap$Modal$modalAttributes(conf.fw),
										conf.fw.a_ ? _List_fromArray(
											[
												A2(
												$elm$html$Html$Events$on,
												'click',
												$rundis$elm_bootstrap$Bootstrap$Modal$containerClickDecoder(conf.aS))
											]) : _List_Nil)),
								_List_fromArray(
									[
										A2(
										...
										A2(
											...
											_List_fromArray(
												[
													...
													$rundis$elm_bootstrap$Bootstrap$Modal$renderFooter(conf.c9)
												])))
									]))
							]))
					]),
...
var $author$project$RCMediaList$mediaPickerView = F4(
	function (buildType, _v0, objectList, messages) {
		...
		var uploadBtn = A2($elm$html$Html$map, $author$project$RCMediaList$MainMessage, messages.e$);
		var tableConfig = A3($author$project$RCMediaList$configMediaPicker, buildType, model.aE, messages);
				...
				[
					...
					_List_fromArray(
						[
							...
							_Utils_Tuple2('dropup', config.a2)
						]))
				]),
			_Utils_ap(
...
var $rundis$elm_bootstrap$Bootstrap$Dropdown$menuStyles = F2(
	function (_v0, config) {
		...
		var _v1 = _Utils_Tuple2(config.a2, config.aW);
		_v1$0:
		while (true) {
			if (!_v1.b.$) {
				if (_v1.b.a === 1) {
						...
						return _Utils_ap(
							...
							_List_fromArray(
								[
									...
									'transform',
									A3(translate, (-toggleSize.e3) - menuSize.e3, 0, 0))
								]));
					}
				}
			} else {
					...
					return _Utils_ap(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$style,
								'transform',
								A3(translate, -toggleSize.e3, toggleSize.d2, 0))
							]));
				}
			}
		}
		return _Utils_ap(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Attributes$style,
					'transform',
					A3(translate, -toggleSize.e3, -menuSize.d2, 0))
				]));
	});
							...
							[
								...
								_List_fromArray(
									[
										...
										_Utils_Tuple2('dropdown-menu-right', config.b1),
										_Utils_Tuple2('show', status !== 2)
									]))
							]),
						_Utils_ap(
...
var $rundis$elm_bootstrap$Bootstrap$Dropdown$defaultOptions = {aP: _List_Nil, aW: $elm$core$Maybe$Nothing, b1: false, a2: false, ca: _List_Nil};
...
var $rundis$elm_bootstrap$Bootstrap$Dropdown$dropdown = F2(
	function (state, _v0) {
		var status = state.eO;
		var toggleMsg = _v0.fF;
		var toggleButton = _v0.fE;
		var items = _v0.fn;
		var options = _v0.fw;
			...
			function (_v0) {
				...
				return $elm$json$Json$Decode$succeed(
					toMsg(
						{
							a8: m,
							eO: $rundis$elm_bootstrap$Bootstrap$Dropdown$nextStatus(status),
							cQ: b
						}));
			},
		...
		return _Utils_ap(
			_List_fromArray(
				[
					...
					_Utils_update(
						_default,
						{x: $author$project$Main$InsertFootnoteAtCursor, aH: '*', dD: 'Insert footnote'})),
					mkButtonTarget(
					_Utils_update(
						_default,
						{i: 18, x: $author$project$Main$OpenMediaPicker, dD: 'Insert media object'})),
					$author$project$Main$separator
				]),
			cmEditor ? _List_fromArray(
				[
					...
					_Utils_update(
						_default,
						{d3: !cmEditor, i: 14, x: $author$project$Main$UndoCM, dD: 'Undo'})),
					mkButtonTarget(
					_Utils_update(
						_default,
						{d3: !cmEditor, i: 15, x: $author$project$Main$RedoCM, dD: 'Redo'})),
					$author$project$Main$separator
				]) : _List_Nil);
	});
...
var $author$project$Exposition$wordCount = function (expo) {
	return $author$project$Util$wordCount(expo.a6);
};
var $author$project$Main$statusBar = F2(
	function (showStatus, model) {
		...
		var saveButtonText = model.H ? 'Saved' : 'Not Saved';
		var saveButton = A2(
			$rundis$elm_bootstrap$Bootstrap$Button$button,
			_List_fromArray(
				[
...
var $rundis$elm_bootstrap$Bootstrap$Form$applyModifier = F2(
	function (modifier, options) {
		...
		return _Utils_update(
			options,
			{
				aP: _Utils_ap(options.aP, value)
			});
	});
var $rundis$elm_bootstrap$Bootstrap$Form$defaultOptions = {aP: _List_Nil};
		...
		switch (_v0) {
			...
			case 1:
				return _Utils_update(
					options,
					{
						cf: $elm$core$Maybe$Just(offset_)
					});
			case 2:
				return _Utils_update(
					options,
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$defaultColOptions = {bx: $elm$core$Maybe$Nothing, by: $elm$core$Maybe$Nothing, bz: $elm$core$Maybe$Nothing, bA: $elm$core$Maybe$Nothing, bB: $elm$core$Maybe$Nothing, aP: _List_Nil, cd: $elm$core$Maybe$Nothing, ce: $elm$core$Maybe$Nothing, cf: $elm$core$Maybe$Nothing, ch: $elm$core$Maybe$Nothing, ci: $elm$core$Maybe$Nothing, cn: $elm$core$Maybe$Nothing, co: $elm$core$Maybe$Nothing, cp: $elm$core$Maybe$Nothing, cq: $elm$core$Maybe$Nothing, cr: $elm$core$Maybe$Nothing, ct: $elm$core$Maybe$Nothing, cu: $elm$core$Maybe$Nothing, cv: $elm$core$Maybe$Nothing, cw: $elm$core$Maybe$Nothing, cx: $elm$core$Maybe$Nothing, cy: $elm$core$Maybe$Nothing, cz: $elm$core$Maybe$Nothing, cA: $elm$core$Maybe$Nothing, cB: $elm$core$Maybe$Nothing, cC: $elm$core$Maybe$Nothing, cP: $elm$core$Maybe$Nothing, bn: $elm$core$Maybe$Nothing, bo: $elm$core$Maybe$Nothing, bp: $elm$core$Maybe$Nothing, bq: $elm$core$Maybe$Nothing, br: $elm$core$Maybe$Nothing};
	...
	return _Utils_ap(
		...
		_Utils_ap(
			$rundis$elm_bootstrap$Bootstrap$Grid$Internal$offsetsToAttributes(
				_List_fromArray(
					[options.ci, options.cf, options.ce, options.cd, options.ch])),
			_Utils_ap(
...
var $rundis$elm_bootstrap$Bootstrap$Grid$renderCol = function (column) {
	switch (column.$) {
		case 0:
			var options = column.a.fw;
			var children = column.a.aR;
			return A2(
				$elm$html$Html$div,
...
var $rundis$elm_bootstrap$Bootstrap$Grid$Internal$defaultRowOptions = {aP: _List_Nil, bY: $elm$core$Maybe$Nothing, bZ: $elm$core$Maybe$Nothing, b_: $elm$core$Maybe$Nothing, b$: $elm$core$Maybe$Nothing, b0: $elm$core$Maybe$Nothing, cU: $elm$core$Maybe$Nothing, cV: $elm$core$Maybe$Nothing, cW: $elm$core$Maybe$Nothing, cX: $elm$core$Maybe$Nothing, cY: $elm$core$Maybe$Nothing};
		...
		_Utils_ap(
			...
			_Utils_ap(
				$rundis$elm_bootstrap$Bootstrap$Grid$Internal$hAlignsToAttributes(
					_List_fromArray(
						[options.b0, options.b_, options.bZ, options.bY, options.b$])),
				options.aP)));
};
		...
		switch (modifier.$) {
			...
			case 4:
				...
				return _Utils_update(
					options,
					{
						cj: $elm$core$Maybe$Just(onChange_)
					});
			case 5:
				...
				return _Utils_update(
					options,
					{
						e0: $elm$core$Maybe$Just(validation_)
					});
			default:
...
var $rundis$elm_bootstrap$Bootstrap$Form$Select$defaultOptions = {aP: _List_Nil, B: false, bU: false, j: $elm$core$Maybe$Nothing, cj: $elm$core$Maybe$Nothing, eL: $elm$core$Maybe$Nothing, e0: $elm$core$Maybe$Nothing};
	...
	return _Utils_ap(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('form-control', !options.B),
						_Utils_Tuple2('custom-select', options.B)
					])),
				$elm$html$Html$Attributes$disabled(options.bU)
			]),
		_Utils_ap(
			A2(
				...
				_List_fromArray(
					[
						...
						$rundis$elm_bootstrap$Bootstrap$Form$Select$sizeAttribute(options.B),
						options.eL),
						A2($elm$core$Maybe$map, $rundis$elm_bootstrap$Bootstrap$Form$Select$customEventOnChange, options.cj),
						A2($elm$core$Maybe$map, $rundis$elm_bootstrap$Bootstrap$Form$Select$validationAttribute, options.e0)
					])),
			options.aP));
};
...
var $author$project$RCMediaEdit$viewClassesPicker = F4(
	function (id, classList, currentSelection, editMessage) {
		var selectItem = function (item) {
			var isSelected = _Utils_eq(currentSelection, item.ds);
			return A2(
				$rundis$elm_bootstrap$Bootstrap$Form$Select$item,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$value(item.ds),
...
var $rundis$elm_bootstrap$Bootstrap$Form$Input$defaultOptions = {aP: _List_Nil, bU: false, j: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, bd: $elm$core$Maybe$Nothing, be: false, cE: false, eL: $elm$core$Maybe$Nothing, bi: 0, e0: $elm$core$Maybe$Nothing, aL: $elm$core$Maybe$Nothing};
...
var $rundis$elm_bootstrap$Bootstrap$Form$Input$toAttributes = function (modifiers) {
	...
	return _Utils_ap(
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class(
				options.be ? 'form-control-plaintext' : 'form-control'),
				$elm$html$Html$Attributes$disabled(options.bU),
				$elm$html$Html$Attributes$readonly(options.cE || options.be),
		...
		_Utils_ap(
			A2(
				...
				_List_fromArray(
					[
						A2($elm$core$Maybe$map, $elm$html$Html$Attributes$id, options.j),
						A2($elm$core$Maybe$andThen, $rundis$elm_bootstrap$Bootstrap$Form$Input$sizeAttribute, options.eL),
						A2($elm$core$Maybe$map, $elm$html$Html$Attributes$value, options.aL),
						...
						A2($elm$core$Maybe$map, $rundis$elm_bootstrap$Bootstrap$Form$Input$validationAttribute, options.e0)
					])),
			options.aP));
};
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$placeholder(props.bd),
								$elm$html$Html$Attributes$value(props.aL),
		...
		switch (modifier.$) {
			...
			case 5:
				...
				return _Utils_update(
					options,
					{
						e0: $elm$core$Maybe$Just(validation)
					});
			default:
				var attrs_ = modifier.a;
				return _Utils_update(
...
var $rundis$elm_bootstrap$Bootstrap$Form$Textarea$defaultOptions = {aP: _List_Nil, bU: false, j: $elm$core$Maybe$Nothing, aC: $elm$core$Maybe$Nothing, cI: $elm$core$Maybe$Nothing, e0: $elm$core$Maybe$Nothing, aL: $elm$core$Maybe$Nothing};
		...
		_Utils_ap(
			A2(
				...
				_List_fromArray(
					[
						A2($elm$core$Maybe$map, $elm$html$Html$Attributes$id, options.j),
						A2($elm$core$Maybe$map, $elm$html$Html$Attributes$rows, options.cI),
						A2($elm$core$Maybe$map, $elm$html$Html$Attributes$value, options.aL),
						A2($elm$core$Maybe$map, $elm$html$Html$Events$onInput, options.aC),
						A2($elm$core$Maybe$map, $rundis$elm_bootstrap$Bootstrap$Form$Textarea$validationAttribute, options.e0)
					])),
			options.aP));
};
...
var $author$project$RCMediaEdit$view = F7(
	function (buildTarget, makeMediaEditFun, closeMediaDialogMsg, insertMediaMsg, insertMediaAsLinkMsg, exposition, model) {
		var emptyDiv = A2($elm$html$Html$div, _List_Nil, _List_Nil);
		var _v0 = model;
		var visibility = _v0.c_;
		var object = _v0.ek;
		var objectViewState = _v0.el;
		var allowInsert = _v0.bC;
		if (!object.$) {
			var obj = object.a;
			if (!objectViewState.$) {
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick(actions_.dR)
									]))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(content_.dR)
							])),
						A2(
						$rundis$elm_bootstrap$Bootstrap$Button$button,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick(actions_.ey)
									]))
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(content_.ey)
							]))
					]),
				A3(
					$rundis$elm_bootstrap$Bootstrap$Modal$body,
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(content_.fx)
								]))
						]),
					A2(
						$rundis$elm_bootstrap$Bootstrap$Modal$hideOnBackdropClick,
						...
						$rundis$elm_bootstrap$Bootstrap$Modal$small(
							$rundis$elm_bootstrap$Bootstrap$Modal$config(actions_.ey))))));
	} else {
		return A2($elm$html$Html$div, _List_Nil, _List_Nil);
	}
};
...
var $author$project$Problems$asString = function (problem) {
	switch (problem.$) {
		...
		default:
			var mime = problem.a;
			return 'Sorry, but import does not support files of type ' + (mime + 'You should try uploading as txt, Word, html, LaTeX , Open/LibreOffice');
	}
};
...
var $author$project$Main$viewAlert = function (model) {
	...
	var realProblems = A2($elm$core$List$filter, isRealProblem, model.bf);
...
var $rundis$elm_bootstrap$Bootstrap$Form$Checkbox$defaultOptions = {aP: _List_Nil, B: false, bU: false, j: $elm$core$Maybe$Nothing, a1: false, ck: $elm$core$Maybe$Nothing, cN: 1, e0: $elm$core$Maybe$Nothing};
	...
	return _Utils_ap(
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('form-check-input', !options.B),
						_Utils_Tuple2('custom-control-input', options.B)
					])),
				$elm$html$Html$Attributes$type_('checkbox'),
				$elm$html$Html$Attributes$disabled(options.bU),
				$rundis$elm_bootstrap$Bootstrap$Form$Checkbox$stateAttribute(options.cN)
			]),
		_Utils_ap(
			A2(
				$elm$core$List$filterMap,
				...
				_List_fromArray(
					[
						A2($elm$core$Maybe$map, $elm$html$Html$Events$onCheck, options.ck),
						A2($elm$core$Maybe$map, $elm$html$Html$Attributes$id, options.j)
					])),
			_Utils_ap(
				function () {
...
var $rundis$elm_bootstrap$Bootstrap$Form$Checkbox$view = function (_v0) {
	var chk = _v0;
	var opts = A3($elm$core$List$foldl, $rundis$elm_bootstrap$Bootstrap$Form$Checkbox$applyModifier, $rundis$elm_bootstrap$Bootstrap$Form$Checkbox$defaultOptions, chk.fw);
	var _v1 = chk.ef;
	var label_ = _v1;
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						_Utils_Tuple2('form-check', !opts.B),
						_Utils_Tuple2('form-check-inline', (!opts.B) && opts.a1),
						_Utils_Tuple2('custom-control', opts.B),
						_Utils_Tuple2('custom-checkbox', opts.B),
						_Utils_Tuple2('custom-control-inline', opts.a1 && opts.B)
					]))
			]),
		_List_fromArray(
			[
					...
					_Utils_ap(
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										_Utils_Tuple2('form-check-label', !opts.B),
										_Utils_Tuple2('custom-control-label', opts.B)
									]))
							]),
						function () {
							var _v2 = opts.j;
	...
	return {
		...
		fw: {
			...
			cJ: $elm$core$Maybe$Just(
				{
					bH: $rundis$elm_bootstrap$Bootstrap$Navbar$Roled(6),
					cc: 1
				}),
			bj: 0
		},
			...
			[
				...
				_List_fromArray(
					[
						...
						_Utils_Tuple2('container', options.b3)
					]))
			]),
		_Utils_ap(
			...
			_Utils_ap(
				_List_fromArray(
					[
						...
						$elm$json$Json$Decode$succeed(
							{
								R: A3($rundis$elm_bootstrap$Bootstrap$Navbar$toggleOpen, state, id, configRec),
								$7: true,
								dx: false
							}))
					]),
...
var $rundis$elm_bootstrap$Bootstrap$Navbar$renderDropdown = F3(
	function (state, configRec, _v0) {
		...
		return A2(
			...
			_List_fromArray(
				[
					A4($rundis$elm_bootstrap$Bootstrap$Navbar$renderDropdownToggle, state, ddRec.j, configRec, ddRec.eX),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
...
var $rundis$elm_bootstrap$Bootstrap$Navbar$view = F2(
	function (state, conf) {
		...
		return A2(
			$elm$html$Html$nav,
			$rundis$elm_bootstrap$Bootstrap$Navbar$navbarAttributes(configRec.fw),
			_Utils_ap(
				$rundis$elm_bootstrap$Bootstrap$Navbar$maybeBrand(configRec.aQ),
				_Utils_ap(
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									...
									_Utils_ap(
										_List_fromArray(
											[
												A3($rundis$elm_bootstrap$Bootstrap$Navbar$renderNav, state, configRec, configRec.fn)
											]),
										$rundis$elm_bootstrap$Bootstrap$Navbar$renderCustom(configRec.bR)))
								]))
						]))));
	});
		...
		return $rundis$elm_bootstrap$Bootstrap$Navbar$customItem(
			A2(
				...
				_List_fromArray(
					[
						props.T,
						$elm$html$Html$Attributes$href(props.P),
						$elm$html$Html$Attributes$target('_blank')
					]),
				_List_fromArray(
					[
...
var $author$project$Main$viewPreviewNavbarItem = F3(
	function (expositionIsSaved, buildType, props) {
		var saveExpositionAttrs = expositionIsSaved ? _List_fromArray(
			[
				$elm$html$Html$Attributes$title(props.dD)
			]) : _List_fromArray(
			[
		...
		var previewUrl = A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$String$fromInt(model.b.dS)
				]));
		...
		return A2(
			...
			A2(
				...
				_List_fromArray(
					[
						navItem(
						{i: 'question.svg', P: 'https://guide.researchcatalogue.net/#text-based-editor', T: $rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml0, dD: 'Help'}),
						navItem(
						{i: 'pencil.svg', P: metaDataUrl, T: $rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml3, dD: 'Show/edit metadata'}),
						A3(
						$author$project$Main$viewPreviewNavbarItem,
						model.H,
						buildType,
						{i: 'eye_metro.svg', P: previewUrl, T: $rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml3, dD: 'Preview'}),
						navItem(
						{i: 'profile_metro.svg', P: 'profile', T: $rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml3, dD: 'Profile'}),
						navItem(
						{i: 'logout_metro.svg', P: 'session/logout', T: $rundis$elm_bootstrap$Bootstrap$Utilities$Spacing$ml3, dD: 'Logout'})
					]),
				A2(
...
var $author$project$Main$view = function (model) {
	var uploadMediaButtonInfo = function () {
		...
		return _Utils_update(
			bttn,
			{
				...
				et: true,
				aH: 'Upload Media',
				dD: 'Add media files: images, video, audio or pdf'
			});
	}();
	var uploadButtonHtml = A3($author$project$Main$viewUpload, model.p, uploadMediaButtonInfo, model.az);
	...
	var mediaDialogHtml = A7($author$project$RCMediaEdit$view, model.p, $author$project$Main$makeMediaEditFun, $author$project$Main$CloseMediaDialog, $author$project$Main$InsertMediaAtCursor, $author$project$Main$InsertMediaAsLinkAtCursor, model.b, model.Q);
	var importDocButtonInfo = function () {
		...
		return _Utils_update(
			bttn,
			{
				...
				et: true,
				aH: 'Import Doc',
				dD: 'Import text from document (Word, Open office, Markdown, LaTeX etc..'
			});
	}();
			...
			[
				...
				_List_fromArray(
					[
						...
						showMediaUpload,
						A3($author$project$Main$viewUpload, model.p, uploadMediaButtonInfo, model.az)),
						A2(
						$author$project$View$optionalBlock,
						showButtons,
						A3($author$project$Main$viewUpload, model.p, importDocButtonInfo, model.a0)),
						A2(
						$author$project$View$optionalBlock,
						showButtons,
						A5(
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$title('Version: ' + model.e1)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(model.e1)
							]))
					])),
				A2(
				$author$project$View$optionalBlock,
				...
				A2(
					...
					A2(
						...
						_List_fromArray(
							[
								editorCheckbox,
								A2($author$project$Main$viewFullscreenSwitch, model.p, model.bW)
							])))),
				alert,
				mediaList,
				A2(
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{fl: $author$project$Main$init, fD: $author$project$Main$subscriptions, fG: $author$project$Main$update, fH: $author$project$Main$view});
