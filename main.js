				...
				body: elm$http$Http$multipartBody(
					_List_fromArray(
						[
							...
							A2(elm$http$Http$stringPart, 'media', 'a'),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2(author$project$RCMediaList$view, model.exposition.media, author$project$Main$MediaDialog),
				saveButton
			]));
};
