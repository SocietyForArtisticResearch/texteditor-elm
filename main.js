...
var $author$project$Main$updateMediaDialog = F3(
	function (model, allowInsert, mediaNameOrId) {
		var _v0 = A2($author$project$Exposition$objectByNameOrId, mediaNameOrId, model.exposition);
		if (_v0.$ === 'Just') {
			var obj = _v0.a;
		...
		while (true) {
			switch (msg.$) {
				...
				case 'MediaEdit':
					...
					var _v12 = A2($author$project$Exposition$objectByNameOrId, objInModelName, model.exposition);
					if (_v12.$ === 'Nothing') {
						var modelWithProblem = A2(
							$author$project$Main$addProblem,
							model,
						...
						var _v13 = $author$project$Exposition$isValid(objViewState.validation);
						if (!_v13) {
							return _Utils_Tuple2(
								_Utils_update(
									model,
				...
				case 'MediaPicker':
					...
					if (pickerMsg.$ === 'SortableTableMessage') {
						...
						var _v29 = model.mediaPickerDialog;
...
var $author$project$Main$makePickerConfig = function (uploadButtonHtml) {
	return {closeModal: $author$project$Main$CloseMediaPicker, insertObject: $author$project$Main$InsertMediaAtCursor, uploadButtonHtml: uploadButtonHtml};
};
